    ...
    <footer>
        <nav>
            <ul class="contact-footer-links">
                <li>
                    <a class="footer-link contact-footer-link" href="https://github.com/Olly-982" target="new" title="link to github profile">
                ...
                <li>
                    <a class="footer-link contact-footer-link" href="https://www.linkedin.com/in/james-vincent-olivier/" target="new" title="link to linkedIn profile">
                        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <li>
                    <a class="footer-link contact-footer-link" href="https://www.facebook.com/jamesvincentdesign" target="new" title="link to facebook">
                        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
