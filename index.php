...
<main class="container">
  <h2 class="greeting"><span class="greeting"></span></h2>
  <div class="cta-wrap">
    <a href="portfolio.php" class="button first">Porfolio</a>
    <a href="contact.php" class="button second contact">Contact</a>
  </div>
